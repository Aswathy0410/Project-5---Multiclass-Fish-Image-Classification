...
# # which automatically augments them. I built a CNN with 3 convolutional blocks that progressively learn features. 
...
print("="*70)
print(f"\n📈 RESULTS:")
print(f"   Original Accuracy:     84.15%")
...
if best_acc >= 0.95:
    ...
    print(f"\n✨ Great! Close to 95% target.")
    print(f"   Try: Increase epochs to 30-40 or use larger images (224x224)")
else:
    print(f"\n💡 Tips to improve further:")
    print(f"   1. Increase epochs (set to 30-40)")
    print(f"   2. Use larger images (224x224)")
